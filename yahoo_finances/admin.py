...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('symbol', 'short_name', 'long_name', 'sector', 'industry', 'exchange', 'quote_type', 'currency',
                    'financial_currency', 'load_date')
    search_fields = ('symbol', 'short_name', 'long_name', 'sector', 'industry', 'exchange', 'quote_type', 'currency',
                     'financial_currency', 'load_date')
    list_filter = ('sector', 'industry', 'exchange', 'quote_type', 'currency', 'financial_currency', 'load_date')
    date_hierarchy = 'load_date'
    ordering = ('symbol', 'short_name', 'long_name', 'sector', 'industry', 'exchange', 'quote_type', 'currency',
                'financial_currency', 'load_date')
